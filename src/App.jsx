  ...
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-6 text-white">
        ...
        <p className="text-blue-100 mt-1">Know before you go. <span className="italic">Setswana: Tseba pele o tsena.</span></p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-emerald-600 to-teal-700 rounded-2xl p-6 text-white">
        ...
        <p className="text-emerald-100 mt-1 italic">Any channel, any phone. <span className="italic">Setswana: Motheo omongwalo, kgakololoo.</span></p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-violet-600 to-purple-700 rounded-2xl p-6 text-white">
        ...
        <p className="text-violet-100 mt-1 italic">Powered by named sources. <span className="italic">Setswana: E na le mantswe a a tseweng.</span></p>
      </div>
